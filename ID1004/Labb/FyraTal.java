...
public class FyraTal {
	 ...
	 */
	private void läsInTal (Scanner scan) {
	...
	private void skrivMinOchMax() {
		...
		System.out.println("Högsta talet: " + talen[MAX_ANTAL - 1]);
	}
	 ...
	 */
	public void kör() {
		läsInTal (new Scanner(System.in));
		skrivSumma();
		skrivMedelvärde();
		skrivProdukt();
		skrivMinOchMax();
