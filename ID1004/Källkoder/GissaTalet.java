...
public class GissaTalet {
	 ...
	 * Men eftersom man kan gissa fel så får man några extra.
	 */
	private final int MAX_ANTAL_GISSNINGAR = 10;
	
	/**
	 * Innehåller det hemliga tal som spelaren ska gissa sig till.
	 */
	...
	private void nollställ() {
		...
		System.out.println("Jag tänker på ett tal ...");
	}
	 ...
	 * @param scan Den Scanner som spelarens gissningar ska hämtas från.
	 */
