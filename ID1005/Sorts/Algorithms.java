...
public class Algorithms {
  ...
  public static void setCounter(Counter counter) {
    Algorithms.counter = counter;
  }

  private static void incComparisons(int amt) {
    if (counter != null) {
      counter.comparisons += amt;
    }
  }

  private static void incDataMoves(int amt) {
    if (counter != null) {
      counter.dataMoves += amt;
    }
  }
  ...
  public static <E> boolean isSorted(
  ...
  private static <E> int partition(
    E[] a, int fromIndex, int toIndex, Comparator<? super E> c) {
    incDataMoves(1);
  ...
  private static <E> void mergeSort(
    E[] a, E[] b, boolean merge_to_a, int fromIndex, int toIndex,
    Comparator<? super E> c) {
    ...
    if (toIndex - fromIndex == 0) {
      ...
      incDataMoves(toIndex - fromIndex);
    }
  }
