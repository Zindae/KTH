 ...
 *     
 * I detta program demonstreras många objekt som printar klockan, i form av digitaltid */
...
public class LAB4_Flera_Konstruktorer 
{
	public static void main(String[] args)
	{
		...
		//dessa kommer använda konstruktorn för lika många argument som instoppat
