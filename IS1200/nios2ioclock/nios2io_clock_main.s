...
loop8:	call	check_key1		
		bne		r2,r0,loop8		#if key1 är tryckt hoppa till loop
		beq		r2,r0,loop		
...
loop:   call	check_key2		#om key2 är tryckt hoppa till loop8
		beq		r2,r0,loop8 
		call	check_key3      # Later changed to call check_key3
