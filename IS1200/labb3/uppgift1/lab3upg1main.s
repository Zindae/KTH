...
main:
    ...
    movia	r6, 0x800020		# in case of interrupt, PC=>0x80020
    movia 	r7, stub			# r7=&stub
    ldw		r8, 0(r7)			# load words from &stub to the right address
    stw		r8, 0(r6)			
    ldw		r8, 4(r7)
    stw		r8, 4(r6)
    ldw		r8, 8(r7)
	...
	movi 	r6, 0x07					# 0x07 means 111, and will turn on the timer, with continious mode 
	stwio	r6, 0(r5)					# and each cycle will trigger an interupt (since index 2 = 1)
